 ...
 * 
 * @param array
 *      array a ser verificada presença de valor
 * @param length
 *      tamanho do array
 * @param value
 *      valor a ser verificado se está contido no array
 * 
 ...
 * 
 * @param matrix
 *      matrix a ser definida o valor
 * @param value
 *      valor a ser definido na memória da matrix
 * @param num_lines
 *      quantidade de linhas da matrix
 * @param num_bytes_per_line
 *      quantidade de bytes por linha da matrix
 * */
 ...
 * 
 * @param matrix
 *      matriz a ser realizado o calloc
 * @param num_lines
 *      quantidade de linhas da matriz
 * @param num_elements_per_line
 *      quantidade de elementos por linha da matriz
 * @param elements_size
 ...
 * 
 * @param point
 *      ponto a ser impresso
 * @param length
 *      dimensão do ponto a ser impresso
 * */
 ...
 * 
 * @param file
 *      arquivo em que o ponto será escrito
 * @param point
 *      ponto a ser impresso
 * @param length
 *      dimensão do ponto a ser escrito
 * */
